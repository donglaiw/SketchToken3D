...
opts=struct('DD',D_name,...
            ...
            'modelFnm',['model_' name(1:end-4)]);
    save(['data/opt_' name],'opts')
end
...
if do_local
    %try;matlabpool;end;
    cd core
    parfor id=1:ntree;st3dTrain_p(3,id);end
    cd ../
else
    PP=pwd;
...
load(['models/forest/' opts.modelFnm])
