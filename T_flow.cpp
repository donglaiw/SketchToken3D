...
/*
II="/home/Stephen/Desktop/VisionLib/OpenCV-2.4.4/modules/video/include/"
LL="-lopencv_core -lopencv_imgproc -lopencv_contrib -lopencv_highgui -lopencv_video"
g++ -I${II} T_flow.cpp ${LL}

LL="-lopencv_core -lopencv_imgproc -lopencv_contrib -lopencv_highgui -lopencv_video"
II="/afs/csail.mit.edu/u/d/donglai/soft/OpenCV-2.4.4/modules/video/include/"
g++ -I${II} T_flow.cpp ${LL}
